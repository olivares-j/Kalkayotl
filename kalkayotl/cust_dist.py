...
def cluster_logp(
    ...
    chol_tn:TensorVariable, # Cholesky decomposition of tail negative
    chol_tp:TensorVariable, # Cholesky decomposition of tail positive
    ...
    lp_tn  = tt.log(weights[1]) + pm.Gamma.logp(-y, alpha=alpha, inv_beta=chol_tn[1,1])
    lp_tp  = tt.log(weights[2]) + pm.Gamma.logp(y, alpha=alpha, inv_beta=chol_tp[1,1])
