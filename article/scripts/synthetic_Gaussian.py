...
# {"location": 500,"fraction":0.1,"case_factor":2,"parametrization":"non-central", 'init':'advi+adapt_diag'},
# {"location": 600,"fraction":0.1,"case_factor":2,"parametrization":"non-central", 'init':'advi+adapt_diag'},
# {"location": 700,"fraction":0.1,"case_factor":2,"parametrization":"non-central", 'init':'advi+adapt_diag'},
# {"location": 800,"fraction":0.1,"case_factor":2,"parametrization":"non-central", 'init':'advi+adapt_diag'},
# {"location": 900,"fraction":0.1,"case_factor":2,"parametrization":"non-central", 'init':'advi+adapt_diag'},
# {"location":1000,"fraction":0.1,"case_factor":1,"parametrization":"non-central", 'init':'advi+adapt_diag'},
# {"location":2000,"fraction":0.1,"case_factor":3,"parametrization":"non-central", 'init':'advi+adapt_diag'},
{"location":3000,"fraction":0.1,"case_factor":3,"parametrization":"non-central", 'init':'advi+adapt_diag'},
{"location":4000,"fraction":0.1,"case_factor":4,"parametrization":"non-central", 'init':'advi+adapt_diag'},
	...
	for case in list_of_cases:
		...
		for prior in list_of_prior:
			for indep in indep_measures:
				...
				location = case["location"]*(1.0+indep["value"])

				hyper_alpha = [location,case["fraction"]*location]
