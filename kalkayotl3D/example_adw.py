...
# You can read a file
fdata = "example.csv"
list_observables = ["ID","RAJ2000","e_RAJ2000","DEJ2000","e_DEJ2000",
"parallax","parallax_error","ra_parallax_corr","dec_parallax_corr"]

data  = pn.read_csv(fdata,usecols=list_observables) # Include the appropriate keywords according to  your file, check pandas documentation.
