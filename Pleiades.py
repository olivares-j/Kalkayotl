...
dir_out    = os.getcwd() + "/Example/Pleiades/"
#--------------------------------------
...
#----------- Data file --------------------
file_data = dir_out + "Pleiades.csv"
#-----------------------------------------
#==================================================
...
astrometry = np.array([[56.59,24.12,7.35,19.98,-45.0,40.0]])
...
for prior in list_of_prior:
	...
	p1d = Inference(dimension=prior["dimension"],     # For now it only works in 3D.
					prior=prior["type"],
	...
	for i in range(3):
		loc[i] = np.array(cluster.get("loc_{0}".format(i))).flatten()
