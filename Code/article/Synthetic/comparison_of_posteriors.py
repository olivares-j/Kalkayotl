...
file_plot  = dir_out   + "Plots/Comparison_of_posteriors.pdf"
file_data  = dir_main  + "Data/" + case + "/" + case + ".csv"
#=======================================================================================================================

#--------------- Read data ----------------------
data = np.array(pn.read_csv(file_data,usecols=["r"]))

#================================== Plot posteriors ==========================================================================
pdf = PdfPages(filename=file_plot)
plt.figure(figsize=(6,6))

plt.hist(data,bins=n_bins,range=range_dist,
...
for j,prior in enumerate(list_of_priors):
	print(prior["type"])
	#-------- Read chain --------------------------------------
	file_csv = (dir_chains + prior["type"] +"/1D_uncorrelated/chain-0.csv")
